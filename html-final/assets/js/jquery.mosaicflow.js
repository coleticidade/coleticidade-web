...
(function(factory) {  // Try to register as an anonymous AMD module
	...
	$.fn.mosaicflow = function(options) {
		...
		return this.each(function() {
			...
			if (!data) {
				...
				elm.data('coleticidadeGrid', data);
			}
	...
	$.fn.mosaicflow.defaults = {
		itemSelector: '> *',
		columnClass: 'coleticidadeGrid__column',
		minItemWidth: 110,
	...
	Mosaicflow.prototype = {
		...
		fillColumns: function() {
			...
			this.container.trigger('coleticidadeGrid-layout');
		},
		...
		generateUniqueId: function() {
			...
			// Return an unique ID
			return 'coleticidadeGrid-' + this.__uid + '-itemid-' + this.__uidItemCounter;
		}
	};
	...
	// Auto init
	$(function() { $('.coleticidadeGrid').mosaicflow(); });
